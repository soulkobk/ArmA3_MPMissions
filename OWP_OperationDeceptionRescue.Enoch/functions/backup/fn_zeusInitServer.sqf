...
_i = 0;
{
	...
	_zeusCurator addEventHandler ["CuratorObjectPlaced",{_this remoteExecCall ["KOBK_fnc_zeusAddObject"];}];
	_zeusCurator addEventHandler ["CuratorObjectDeleted",{_this remoteExecCall ["KOBK_fnc_zeusDeleteObject"];}];
