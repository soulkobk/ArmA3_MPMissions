...
for "_i" from 0 to (count _cfgWeapons)-1 do
{
	...
	if (isClass _curWeapon) then
	{
		...
		systemChat format ["[%1] processing item %2",_i,_displayName];
...
systemChat "PASTE ALL WEAPONS TO A TXT FILE!";
uisleep 10;
///////////////////////////////////////////////////////////////////////////////////////////////////	
...
systemChat "PASTE ALL MAGAZINES TO A TXT FILE!";
uisleep 10;
///////////////////////////////////////////////////////////////////////////////////////////////////	
_cfgWeapons = configFile >> "CfgWeapons";
_items = [];
...
systemChat "PASTE ALL ITEMS TO A TXT FILE!";
uisleep 10;
///////////////////////////////////////////////////////////////////////////////////////////////////	
...
copyToClipboard str _backpacks;
systemChat "PASTE ALL BACKPACKS TO A TXT FILE!";
uisleep 10;
///////////////////////////////////////////////////////////////////////////////////////////////////	
systemChat "COMPLETE, PASTE TO A TXT FILE!";
