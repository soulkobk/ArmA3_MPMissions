/*
	...
	["ordersCall",1,100] spawn OWP_fnc_friendlyAreaPlaySound3D;
	or
	["ordersCall",1,100] remoteExec ["OWP_fnc_friendlyAreaPlaySound3D",2]; // execute on server only, effect global (to all connected clients)
