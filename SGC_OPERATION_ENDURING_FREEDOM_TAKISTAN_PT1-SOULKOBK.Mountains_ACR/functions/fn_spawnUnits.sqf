...
{
	_positionArr = [_unitMarker,_unitClassNumber] call SGC_fnc_buildingPositions; // custom function
}
else
{
...
_i = 0;
{
	...
	[_unitObject,_unitSkill] spawn SGC_fnc_aiSetSkill; // custom function
