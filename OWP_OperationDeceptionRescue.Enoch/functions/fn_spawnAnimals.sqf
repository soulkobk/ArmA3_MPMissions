...
_i = 0;
{
	...
	[_animalObject] spawn KOBK_fnc_unitEventHandler;
	...
	switch (_animalControl) do
	{
		case "PATROL": {
			...
			_animalTask = [_animalGroup,_animalPosition,_animalControlInfo,5,"MOVE",_animalBehaviour,selectRandom ["GREEN","WHITE","YELLOW","RED"],_animalSpeed,selectRandom ["COLUMN","STAG COLUMN","WEDGE","VEE","LINE"],"",[3,6,9]] call CBA_fnc_taskPatrol;
		};
		case "SEEK": {
