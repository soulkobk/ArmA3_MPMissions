...
params [["_markerName",""],["_cleanUpDuration",120],["_cleanUpSleep",10]];

if (_markerName isEqualTo "") exitWith {};

_cleanUpPos = getMarkerPos _markerName;
_cleanUpRadius = selectMax (getMarkerSize _markerName); // maximum radius in meters.
